---
article_id: KAY-10-A03
title: "Sambungan Kayu Struktural: Serat, Jarak Tepi, Kelembapan, dan Korosi"
slug: "konsep-sambungan-kayu-struktural"
description: "Explain force transfer, grain direction, splitting, fastener/connector evidence, moisture movement, corrosion, and inspection access"
status: outline
publication_date: "2025-12-30"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KAY-10
primary_intent: "Understand connection design inputs"
reader_community: "Kayu.co.id"
reader_address: "Kawan Kayu.co.id"
final_route: "/artikel/konsep-sambungan-kayu-struktural.html"
...
# Sambungan Kayu Struktural: Serat, Jarak Tepi, Kelembapan, dan Korosi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Sambungan Kayu Struktural: Serat, Jarak Tepi, Kelembapan, dan Korosi”
- **Reader and situation:** Architect coordinating a timber connection
- **Reader outcome:** Explain force transfer, grain direction, splitting, fastener/connector evidence, moisture movement, corrosion, and inspection access
- **Primary intent:** Understand connection design inputs
...
- **Scope boundary:** Excludes connection size/count/layout, owned by a qualified structural engineer; furniture joints belong to KAY-15-A03
- **Final public route:** `/artikel/konsep-sambungan-kayu-struktural.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Sambungan Kayu Struktural: Serat, Jarak Tepi, Kelembapan, dan Korosi**.
...
- **TOPIC-GATE:** G-01, G-04, G-06, G-10
...
- `KAY-10-A01` → `/artikel/jalur-beban-struktur-kayu.html` — Jalur Beban pada Struktur Kayu: Pertanyaan Sebelum Memilih Balok
- `KAY-10-A02` → `/artikel/mutu-struktural-dan-nilai-desain.html` — Mutu Struktural dan Nilai Desain Kayu: Mengapa Data Jenis Belum Cukup
- `KAY-10-A04` → `/artikel/lubang-takikan-retak-balok-kayu.html` — Lubang, Takikan, Retak, dan Ujung Balok: Kapan Harus Berhenti Memotong
- `KAY-10-A05` → `/artikel/glulam-lvl-clt-untuk-struktur.html` — Glulam, LVL, dan CLT sebagai Struktur: Bukti yang Harus Menyertai Produk
...
- **Tie back to this article:** Keep the explanation specific to “Sambungan Kayu Struktural: Serat, Jarak Tepi, Kelembapan, dan Korosi”.
