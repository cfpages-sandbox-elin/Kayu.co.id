---
article_id: KAY-16-A05
title: "Perbaikan Lokal Kayu: Kapan Kosmetik Menutupi Masalah yang Lebih Besar"
slug: "perbaikan-lokal-kayu"
description: "Separate cause correction, non-load cosmetic damage, moisture/pest activity, bond/finish compatibility, test patch, and replacement triggers"
status: outline
publication_date: "2026-05-31"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KAY-16
primary_intent: "Decide whether a local repair is appropriate"
reader_community: "Kayu.co.id"
reader_address: "Teman Kayu.co.id"
final_route: "/artikel/perbaikan-lokal-kayu.html"
...
# Perbaikan Lokal Kayu: Kapan Kosmetik Menutupi Masalah yang Lebih Besar

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Perbaikan Lokal Kayu: Kapan Kosmetik Menutupi Masalah yang Lebih Besar”
- **Reader and situation:** Owner considering filler, patch, splice, or refinish
- **Reader outcome:** Separate cause correction, non-load cosmetic damage, moisture/pest activity, bond/finish compatibility, test patch, and replacement triggers
- **Primary intent:** Decide whether a local repair is appropriate
...
- **Scope boundary:** Excludes structural repair design owned by KAY-10-A06 and pesticide treatment owned by licensed professionals
- **Final public route:** `/artikel/perbaikan-lokal-kayu.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Perbaikan Lokal Kayu: Kapan Kosmetik Menutupi Masalah yang Lebih Besar**.
...
- `KAY-16-A04` → `/artikel/diagnosis-delaminasi-panel-veneer.html` — Delaminasi Plywood atau Veneer: Mencari Penyebab sebelum Menempel Ulang
...
- **Tie back to this article:** Keep the explanation specific to “Perbaikan Lokal Kayu: Kapan Kosmetik Menutupi Masalah yang Lebih Besar”.
