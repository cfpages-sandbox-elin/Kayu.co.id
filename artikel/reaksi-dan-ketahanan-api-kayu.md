---
article_id: KAY-11-A02
title: "Reaksi terhadap Api dan Ketahanan Api: Dua Klaim yang Berbeda"
slug: "reaksi-dan-ketahanan-api-kayu"
description: "Separate surface reaction, smoke, fire resistance, test assembly, duration, substrate, field application, and jurisdiction"
status: outline
publication_date: "2026-01-18"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KAY-11
primary_intent: "Distinguish fire test claims"
reader_community: "Kayu.co.id"
reader_address: "Kawan Kayu.co.id"
final_route: "/artikel/reaksi-dan-ketahanan-api-kayu.html"
...
# Reaksi terhadap Api dan Ketahanan Api: Dua Klaim yang Berbeda

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Reaksi terhadap Api dan Ketahanan Api: Dua Klaim yang Berbeda”
- **Reader and situation:** Buyer reviewing a coating or panel certificate
- **Reader outcome:** Separate surface reaction, smoke, fire resistance, test assembly, duration, substrate, field application, and jurisdiction
- **Primary intent:** Distinguish fire test claims
...
- **Scope boundary:** Excludes certificate approval or equivalence, owned by fire professional/regulator
- **Final public route:** `/artikel/reaksi-dan-ketahanan-api-kayu.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Reaksi terhadap Api dan Ketahanan Api: Dua Klaim yang Berbeda**.
...
- **Tie back to this article:** Keep the explanation specific to “Reaksi terhadap Api dan Ketahanan Api: Dua Klaim yang Berbeda”.
