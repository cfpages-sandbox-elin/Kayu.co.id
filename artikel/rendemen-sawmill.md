---
article_id: KAY-05-A03
title: "Rendemen Sawmill: Ke Mana Volume Log Berubah"
slug: "rendemen-sawmill"
description: "Break down kerf, edging, defects, shrinkage, target sizes, residues, and why yield percentages need a defined basis"
status: outline
publication_date: "2025-08-31"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KAY-05
primary_intent: "Analyze recovery and loss"
reader_community: "Kayu.co.id"
reader_address: "Kawan Kayu.co.id"
final_route: "/artikel/rendemen-sawmill.html"
...
# Rendemen Sawmill: Ke Mana Volume Log Berubah

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Rendemen Sawmill: Ke Mana Volume Log Berubah”
- **Reader and situation:** Mill manager or buyer comparing conversion proposals
- **Reader outcome:** Break down kerf, edging, defects, shrinkage, target sizes, residues, and why yield percentages need a defined basis
- **Primary intent:** Analyze recovery and loss
...
- **Scope boundary:** Excludes log-purchase valuation and actual commercial price owned by KAY-18-A03
- **Final public route:** `/artikel/rendemen-sawmill.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Rendemen Sawmill: Ke Mana Volume Log Berubah**.
...
- **Tie back to this article:** Keep the explanation specific to “Rendemen Sawmill: Ke Mana Volume Log Berubah”.
