---
article_id: KAY-17-A05
title: "Serbuk Gergaji, Offcut, Kulit, dan Sludge: Memetakan Residu Produksi Kayu"
slug: "residu-produksi-kayu"
description: "Classify clean/treated/coated/contaminated residues, storage/fire risk, reuse routes, contamination controls, records, and disposal verification"
status: outline
publication_date: "2026-06-24"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KAY-17
primary_intent: "Plan residue handling"
reader_community: "Kayu.co.id"
reader_address: "Sobat Kayu.co.id"
final_route: "/artikel/residu-produksi-kayu.html"
...
# Serbuk Gergaji, Offcut, Kulit, dan Sludge: Memetakan Residu Produksi Kayu

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Serbuk Gergaji, Offcut, Kulit, dan Sludge: Memetakan Residu Produksi Kayu”
- **Reader and situation:** Mill seeking safe, traceable material recovery
- **Reader outcome:** Classify clean/treated/coated/contaminated residues, storage/fire risk, reuse routes, contamination controls, records, and disposal verification
- **Primary intent:** Plan residue handling
...
- **Scope boundary:** Excludes declaring waste legal classification without current regulation and bioenergy system design
- **Final public route:** `/artikel/residu-produksi-kayu.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Serbuk Gergaji, Offcut, Kulit, dan Sludge: Memetakan Residu Produksi Kayu**.
...
- `/kegiatan-produksi/` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `KAY-17-A03` → `/artikel/pengendalian-kimia-workshop-kayu.html` — Lem, Pelarut, dan Finishing di Workshop: Hirarki Pengendalian Paparan
- `KAY-17-A04` → `/artikel/kebisingan-getaran-ergonomi-pengolahan-kayu.html` — Kebisingan, Getaran, dan Ergonomi pada Pengolahan Kayu
- `KAY-17-A06` → `/artikel/audit-k3-workshop-kayu.html` — Audit K3 Workshop Kayu: Bukti, Temuan, Tindakan, dan Verifikasi
...
- **Tie back to this article:** Keep the explanation specific to “Serbuk Gergaji, Offcut, Kulit, dan Sludge: Memetakan Residu Produksi Kayu”.
