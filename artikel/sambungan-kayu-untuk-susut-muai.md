---
article_id: KAY-15-A03
title: "Sambungan Kayu yang Memberi Ruang untuk Susut dan Muai"
slug: "sambungan-kayu-untuk-susut-muai"
description: "Explain grain orientation, fixed/slotted concepts, floating panels, fastener clearance, adhesive restraint, and service movement"
status: outline
publication_date: "2026-05-01"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KAY-15
primary_intent: "Detail non-structural movement allowances"
reader_community: "Kayu.co.id"
reader_address: "Teman Kayu.co.id"
final_route: "/artikel/sambungan-kayu-untuk-susut-muai.html"
...
# Sambungan Kayu yang Memberi Ruang untuk Susut dan Muai

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Sambungan Kayu yang Memberi Ruang untuk Susut dan Muai”
- **Reader and situation:** Fabricator joining solid wood to frames/panels
- **Reader outcome:** Explain grain orientation, fixed/slotted concepts, floating panels, fastener clearance, adhesive restraint, and service movement
- **Primary intent:** Detail non-structural movement allowances
...
- **Scope boundary:** Excludes structural connections owned by KAY-10-A03 and furniture ergonomics/style owned by `furnitur.co.id`
- **Final public route:** `/artikel/sambungan-kayu-untuk-susut-muai.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Sambungan Kayu yang Memberi Ruang untuk Susut dan Muai**.
...
- `KAY-15-A01` → `/artikel/arah-serat-saat-mesin-kayu.html` — Membaca Arah Serat sebelum Memotong, Menyerut, dan Membentuk Kayu
- `KAY-15-A02` → `/artikel/persiapan-permukaan-untuk-lem-kayu.html` — Menyiapkan Permukaan Kayu untuk Pengeleman
- `KAY-15-A04` → `/artikel/pilot-hole-dan-fastener-kayu.html` — Sekrup, Paku, dan Pilot Hole pada Kayu: Mencegah Belah dan Kerusakan Tepi
...
- **Tie back to this article:** Keep the explanation specific to “Sambungan Kayu yang Memberi Ruang untuk Susut dan Muai”.
