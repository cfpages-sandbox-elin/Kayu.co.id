---
article_id: KAY-02-A03
title: "Sengon, Jabon, dan Mahoni: Membandingkan Sifat, Bukan Sekadar Reputasi"
slug: "sengon-jabon-mahoni-sifat"
description: "Compare density/property ranges, machining, appearance, durability, and uncertainty under stated conditions"
status: outline
publication_date: "2025-06-23"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KAY-02
primary_intent: "Compare three site-relevant species by evidence"
reader_community: "Kayu.co.id"
reader_address: "Sobat Kayu.co.id"
final_route: "/artikel/sengon-jabon-mahoni-sifat.html"
...
# Sengon, Jabon, dan Mahoni: Membandingkan Sifat, Bukan Sekadar Reputasi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Sengon, Jabon, dan Mahoni: Membandingkan Sifat, Bukan Sekadar Reputasi”
- **Reader and situation:** Buyer considering current veneer raw materials
- **Reader outcome:** Compare density/property ranges, machining, appearance, durability, and uncertainty under stated conditions
- **Primary intent:** Compare three site-relevant species by evidence
...
- **Scope boundary:** Excludes current stock/price owned by `/veneer/albasia/`, `/veneer/jabon/`, and `/veneer/mahogany/`
- **Final public route:** `/artikel/sengon-jabon-mahoni-sifat.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Sengon, Jabon, dan Mahoni: Membandingkan Sifat, Bukan Sekadar Reputasi**.
...
- **Exact Markdown to insert:** `![Ilustrasi kayu sengon](/wp-content/uploads/2020/08/kayu-sengon.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `kayu sengon` as relevant content media; no pixels were inspected.
...
- `KAY-02-A01` → `/artikel/cara-identifikasi-jenis-kayu.html` — Cara Mengidentifikasi Jenis Kayu Tanpa Menebak dari Warna Saja
- `KAY-02-A02` → `/artikel/nama-lokal-dagang-botani-kayu.html` — Nama Lokal, Nama Dagang, dan Nama Botani Kayu: Cara Mencegah Salah Beli
- `KAY-02-A04` → `/artikel/berat-jenis-dan-kerapatan-kayu.html` — Berat Jenis dan Kerapatan Kayu: Apa yang Bisa dan Tidak Bisa Disimpulkan
- `KAY-02-A05` → `/artikel/pemeriksaan-dugaan-substitusi-kayu.html` — Kayu Mirip Bukan Berarti Sama: Pemeriksaan Saat Ada Dugaan Substitusi
...
- **Tie back to this article:** Keep the explanation specific to “Sengon, Jabon, dan Mahoni: Membandingkan Sifat, Bukan Sekadar Reputasi”.
